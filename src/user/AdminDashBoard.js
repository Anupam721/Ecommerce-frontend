...
const AdminDashboard= () => {
    ...
    const adminRightSide = () => {
        return (
            <div className='card mb-4'>
                ...
                <ul className='list-group'>
                    <li className='list-group-item'>
                        <span className='badge bg-success m-3'>Name:</span>{name}
                    </li>
                    <li className='list-group-item'>
                        <span className='badge bg-success m-3'>Email:</span>{email}
                    </li>
                    <li className='list-group-item'>
                        <span className='badge bg-danger m-3'>Admin Privileges Granted</span>
                    </li>
                </ul>
            </div>
        )
    ...
    return(
        <Base title='Welcome to the Admin-Dashboard' description='Manage all of your products here'
